...
/***/ function(module, exports, __webpack_require__) {
	...
	var SokoBanGame = _react2.default.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    addMyKeyboardEvent(document, "keydown", function (e) {
	      ...
	      if (state.state == 'GAME' && state.level.finished && e.keyCode == 32) {
	        this.progressLevel(e);
	      }
	
	      if (state.state == 'GAME' && e.keyCode == '27') {
	        this.resetLevel(e);
	      }
	
	      if (state.state == 'GAME' && !state.level.finished) {
	        switch (e.keyCode) {
	          case 38:
	  ...
	  resetLevel: function resetLevel(event) {
	  ...
	  progressLevel: function progressLevel(event) {
	    event && event.preventDefault();
	  ...
	  render: function render() {
	    ...
	    switch (state.state) {
	      case 'GAME':
	        gameState = _react2.default.createElement(_Game2.default, {
	      ...
	      case 'LOADING':
	        gameState = _react2.default.createElement(_Loader2.default, null);
	        break;
	
	      case 'ERROR':
	        gameState = _react2.default.createElement(
	          'div',
	          null,
	          'Error happened'
	        );
	      ...
	      default:
	        gameState = _react2.default.createElement(_Menu2.default, {
	          store: this.props.store,
	...
	var render = function render() {
	  _reactDom2.default.render(_react2.default.createElement(SokoBanGame, { store: _store2.default }), document.getElementById('SokoBanGame'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _level = __webpack_require__(183);
	
	var _level2 = _interopRequireDefault(_level);
	
	var _scenario = __webpack_require__(184);
	...
	var reducers = (0, _redux.combineReducers)({
	  ...
	  scenario: _scenario2.default,
	  level: _level2.default
	});
...
/***/ function(module, exports) {
	...
	function state() {
		var state = arguments.length <= 0 || arguments[0] === undefined ? 'MENU' : arguments[0];
		var action = arguments[1];
...
/***/ function(module, exports) {
	...
	function level() {
	    ...
	    var repeatArrayPush = function repeatArrayPush(number, item, array) {
	    ...
	    var expandRow = function expandRow(row) {
	        var cells = row.split(/(\d+|\D{1})/).filter(Boolean),
	            result = [];
	        ...
	        for (var counter = 0; counter < cells.length; counter++) {
	            if (isNaN(cells[counter])) {
	                ...
	                repeatArrayPush(cells[counter], cells[counter + 1], result);
	                counter++;
	            }
	        }
	    ...
	    var movePlayer = function movePlayer() {
	        var yOffset = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
	        ...
	        var playerX = void 0,
	            ...
	            itemState = void 0,
	            newItemState = void 0,
	            bondItemState = void 0,
	            newBondItemState = void 0,
	            newPlayerState = void 0,
	        ...
	        if ('$*'.indexOf(itemState) !== -1 && ' -_.'.indexOf(bondItemState) !== -1) {
	    ...
	    switch (action.type) {
	        case 'LOADLEVEL':
	            ...
	            exports.default = level = Object.assign({}, action.scenario.levels[action.scenario.currentLevel]);
...
/***/ function(module, exports) {
	...
	function scenario() {
		...
		switch (action.type) {
			...
			case 'LOADSCENARIO':
				var pack = Object.assign({}, action.scenario);
				pack.currentLevel = 0;
				return pack;
	
			case 'PROGRESSLEVEL':
				var scenarioPack = Object.assign({}, state);
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						"a",
						{ href: "#", onClick: props.onStartGame },
						"New Game"
					)
				),
				_react2.default.createElement(
	...
	function Game(props) {
		...
		var state = props.store.getState(),
			...
			var cells = row.map(function (cell, index) {
				...
				return _react2.default.createElement('div', { className: 'gameCell', style: itemStyle, key: index });
			});
	
			return _react2.default.createElement(
				'div',
				{ className: 'gameRow', key: index },
				cells
			);
		});
	
		var nextLevel = level.finished ? _react2.default.createElement(
			'button',
			{ onClick: props.progressLevel },
			'Next Level(Space)'
		) : '';
		...
		return _react2.default.createElement(
			...
			null,
			'(',
			state.scenario.currentLevel + 1,
			' / ',
			state.scenario.levels.length,
			') - ',
			level.title,
			gameMap,
			_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".gameRow {\n  display: block;\n  height: 32px; }\n\n.gameCell {\n  display: block;\n  float: left;\n  width: 32px;\n  height: 32px; }\n", ""]);
